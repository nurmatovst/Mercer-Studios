    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-16 px-6 md:px-12 lg:px-24">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-gold text-sm tracking-[0.3em] uppercase mb-4">{t("projectsPage.label")}</p>
          <h1 className="font-serif text-4xl md:text-6xl text-foreground mb-6">{t("projectsPage.title")}</h1>
          <p className="text-muted-foreground text-lg max-w-2xl">{t("projectsPage.description")}</p>
        </div>
      </section>
              ...
              >
                ...
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <h3 className="font-serif text-xl text-foreground mb-1">{t(project.titleKey)}</h3>
